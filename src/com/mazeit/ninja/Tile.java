...
public class Tile {
	...
	public Tile(int x, int y, int typeInt) {
		...
		if (type == 5) {
			tileImage = MapLoader.tiledirt;
		} else if (type == 8) {
			tileImage = MapLoader.tilegrassTop;
		} else if (type == 4) {
			tileImage = MapLoader.tilegrassLeft;

		} else if (type == 6) {
			tileImage = MapLoader.tilegrassRight;

		} else if (type == 2) {
			tileImage = MapLoader.tilegrassBot;
		} else {
			type = 0;
		}
